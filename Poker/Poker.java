...
class Poker {
	...
	// static int time = 0; // the time we will wait between two players (seconds)
	...
	// static void wait() {try {Thread.sleep(time * 1000);} catch (InterruptedException e) {}}
	 // time is in seconds, we convert it into milliseconds
	...
	static void clear() {System.out.println(clearScreen);}
